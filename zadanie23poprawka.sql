...
-- 2 
insert into 
	pracownik (imię, nazwisko, wypłata, data_urodzenia, stanowisko)
values
...
-- 12
insert into 
	adres (ulica_nr_domu, kod_pocztowy, miejscowość)
values
...
insert into 
	pracownik (imię, nazwisko, stan_id, ad_id)
values
	('Anna', 'Burnopka', 1, 2),
	('Łukasz', 'Kieł', 2, 1),
	('Bartłomiej', 'Kalosz', 3, 3
 );
 -- 13 
